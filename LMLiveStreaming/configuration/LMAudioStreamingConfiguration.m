//
//  LMAudioStreamingConfiguration.m
//  LMLiveStreaming
//
...
@implementation LMAudioStreamingConfiguration

#pragma mark -- LifyCycle
+ (instancetype)defaultConfiguration{
    LMAudioStreamingConfiguration *audioConfig = [LMAudioStreamingConfiguration defaultConfigurationForQuality:LMStreamingAudioQuality_Default];
    return audioConfig;
}

+ (instancetype)defaultConfigurationForQuality:(LMStreamingAudioQuality)audioQuality{
    LMAudioStreamingConfiguration *audioConfig = [LMAudioStreamingConfiguration new];
    ...
    audioConfig.audioSampleRate = [LMAudioStreamingConfiguration isNewThaniPhone6] ? LMStreamingAudioSampleRate_48000Hz : LMStreamingAudioSampleRate_44100Hz;
...
- (BOOL)isEqual:(id)other{
    if (other == self) {
        ...
        LMAudioStreamingConfiguration *object = other;
...
- (id)copyWithZone:(nullable NSZone *)zone{
    LMAudioStreamingConfiguration *other = [self.class defaultConfiguration];
    return other;
}
